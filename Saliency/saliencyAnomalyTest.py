...
def __main__():
    ...
    dataloaders_dict, test_names = anomaly_initializeDataset.initialize_anomaly_dataset(path_dataset, train_videos_path, test_videos_path, dataset_source, batch_size,

...
def plot_sample(img1, img2, img3, title):
...
def init(batch_size, num_workers, debugg_mode, numDiPerVideos, dataset_source, data_transforms, interval_duration, avgmaxDuration):
